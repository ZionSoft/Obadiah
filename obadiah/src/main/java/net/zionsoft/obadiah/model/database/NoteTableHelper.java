...
public class NoteTableHelper {
    ...
    static void createTable(SQLiteDatabase db) {
        db.execSQL(String.format("CREATE TABLE %s (%s INTEGER NOT NULL, %s INTEGER NOT NULL, %s INTEGER NOT NULL, %s TEXT NOT NULL, %s INTEGER NOT NULL, PRIMARY KEY (%s, %s, %s));",
    ...
    public static void removeNote(SQLiteDatabase db, VerseIndex verseIndex) {
        db.delete(TABLE_NOTE, String.format("%s = ? AND %s = ? AND %s = ?",
